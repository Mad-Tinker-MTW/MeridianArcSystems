...
export const roadmap = [
  { phase: "Built", count: 105, label: "Knowledge objects, glossary terms, applications, and learning paths have permanent homes.", status: "Complete" },
  ...
  { phase: "Next", count: 1, label: "The GEN ledger will record completed capability, evidence, time, and Return on Time.", status: "Active" }
];
