...
export const roadmap = [
  { phase: "Built", count: 106, label: "Knowledge objects, glossary terms, applications, learning paths, and the GEN ledger have permanent homes.", status: "Complete" },
  ...
  { phase: "Next", count: 1, label: "The Meridian Journal will preserve observations, reactions, decisions, and learning across cycles.", status: "Active" }
];
