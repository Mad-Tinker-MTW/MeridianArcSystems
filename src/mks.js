...
export const roadmap = [
  { phase: "Built", count: 70, label: "Knowledge objects and glossary terms have permanent, searchable homes.", status: "Complete" },
  ...
  { phase: "Next", count: 25, label: "Real applications and worked scenarios will test the system across domains.", status: "Active" }
];
