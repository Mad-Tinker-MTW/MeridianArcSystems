...
export const roadmap = [
  { phase: "Built", count: 95, label: "Knowledge objects, glossary terms, and worked applications have permanent homes.", status: "Complete" },
  ...
  { phase: "Next", count: 10, label: "Guided Academy learning paths will turn the specification into teachable capability.", status: "Active" }
];
